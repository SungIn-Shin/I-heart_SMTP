package com.iheart.ssi.smtp.hanmail;
 ...
 */
public class SendMailDaum {

	public static void main(String[] args) {
		List<String> toMail = new ArrayList<>();
		toMail.add("tlstjddls123@naver.com"); // 받는사람 메일
		String fromMail = "sin5149@hanmail.net"; // 보내는사람 메일
		try {
			SendMailDaum.send(toMail, fromMail, "hello SMTP test", "Title Test", "", "sin5149",
					"utvnprynwgfvzjbz");
		} catch (Exception e) {
			//
			e.printStackTrace();
